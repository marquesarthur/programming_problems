...
def breadth_first(graph, start, end):
    """
        this is similar to breadth in a tree.
        as soon as you find a path, then return
...
# path from 0 to 3 = 6
path = breadth_first(graph, 0, 3)
print(path)
#
# # path from 0 to 1 = 9
# path = breadth_first(graph, 0, 1)
# print(path)
#
# # path from 1 to 0 = 15
# path = breadth_first(graph, 1, 0)
# print(path)
